...
<head>
    ...
    <title>@yield('title', 'Dashboard') | {{ config('app.name', 'Asset Managment') }}</title>

    <meta name="description" content="" />

    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="{{ asset('assets/img/icons/brands/logo.png') }}" />
        ...
        <div class="layout-container">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    @if ($errors->any())
                        $('.modal').each(function() {
                            if ($(this).find('.is-invalid, .invalid-feedback').length > 0) {
