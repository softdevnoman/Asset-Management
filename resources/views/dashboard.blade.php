                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-primary"><i class="ti tabler-box ti-md"></i></span>
                        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-success"><i class="ti tabler-currency-dollar ti-md"></i></span>
                        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-info"><i class="ti tabler-user-check ti-md"></i></span>
                        </div>
        ...
        <div class="col-sm-6 col-lg-3">
            <div class="card h-100">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-2 pb-1">
                        <div class="avatar me-2">
                            <span class="avatar-initial rounded bg-label-danger"><i class="ti tabler-tool ti-md"></i></span>
                        </div>
        ...
        <div class="col-xl-6 col-12 mb-4">
            <div class="card h-100">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="dropdown">
                        <button class="btn p-0" type="button" id="conditionDropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <div class="card-body pb-0">
                    ...
                    <ul class="p-0 m-0 mt-4 mb-4 list-unstyled">
                        <li class="d-flex mb-3">
                            <span class="badge bg-label-success me-2 rounded-circle p-2"><i class="ti tabler-check ti-sm"></i></span>
                        ...
                        <li class="d-flex mb-3">
                            <span class="badge bg-label-warning me-2 rounded-circle p-2"><i class="ti tabler-alert-circle ti-sm"></i></span>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
                        ...
                        <li class="d-flex">
                            <span class="badge bg-label-danger me-2 rounded-circle p-2"><i class="ti tabler-x ti-sm"></i></span>
                            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                <div class="me-2">
